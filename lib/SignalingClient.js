...
export class SignalingClient extends EventEmitter {
    static DEFAULT_CLIENT_ID = 'MASTER';
    websocket = null;
    readyState = ReadyState.CLOSED;
    requestSigner;
    config;
    pendingIceCandidatesByClientId = {};
    hasReceivedRemoteSDPByClientId = {};
    dateProvider;
    /**
     ...
     */
    sendSdpOffer(sdpOffer, recipientClientId, correlationId) {
     ...
     * Signaling will send a StatusResponse message describing the error. If this is not present, no error will be returned.
     */
    sendSdpAnswer(sdpAnswer, recipientClientId, correlationId) {
     ...
     * Signaling will send a StatusResponse message describing the error. If this is not present, no error will be returned.
     */
    sendIceCandidate(iceCandidate, recipientClientId, correlationId) {
     ...
     */
    sendMessage(action, messagePayload, recipientClientId, correlationId) {
     ...
     */
    static parseJSONObjectFromBase64String(base64EncodedString) {
        try {
     ...
     */
    static serializeJSONObjectAsBase64String(object) {
        try {
     ...
     */
    emitOrQueueIceCandidate(iceCandidate, clientId) {
     ...
     */
    emitPendingIceCandidates(clientId) {
        const clientIdKey = clientId || SignalingClient.DEFAULT_CLIENT_ID;
     ...
     */
    validateRecipientClientId(recipientClientId) {
